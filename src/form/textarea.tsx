...
export class Textarea<T> extends Input<InputNameCheckProps<T>>{
    ...
    render(props: any, state: any) {
        ...
        return <div class="form-group vertical-top">
            ...
            <textarea style={this.props.inputStyle} disabled={props.disabled} value={this.getValue()} ref={x => this.te = x} autocomplete="off" onInput={this.getOnChange()} required={this.props.required} name={this.props.name} onChange={this.getOnChange()} class={this.inputClass} rows={rows} cols={cols}></textarea>
        </div>
    }
}